...
![](.readme/youtube-thumbnail-200.png)
...
![Screenshot from the MERN app](.readme/app-mern.png)
...
![Screenshot from the hello app](.readme/app-hello.png)
...
![skaffold in action](.readme/skaffold-in-action.gif)
...
![Graphic describing the infrastructure](.readme/kodrops-infra.png)
...
![Testing the client](.readme/pipeline-tests-client-success.png)
_The client app passes its tests_

![Testing the backend](.readme/pipeline-tests-backend-fail.png)
...
![Using Terraform in the CI/CD pipeline to create the infrastructure](.readme/pipeline-deploy-gcp-1.png)
_Deploying the infrastructure via Terraform..._

![Deploying the Kubernetes side of the infrastructure](.readme/pipeline-deploy-gcp-2.png)
_... and then deploying the Kubernetes manifests_

![Building and deploying the Docker image for the client app](.readme/pipeline-deploy-client.png)
...
![Screenshot displaying some of the custom metrics exposed by the express backend](.readme/monit-metrics.png)
_Some of the custom metrics exposed by the express backend_

![The dashboard in Grafana](.readme/monit-grafana.png)
